...
var settings = {
    ...
    url_dl: "https://storage.googleapis.com/gweb-uniblog-publish-prod/original_images/DAP_story_first.gif", // path to a large file or garbage.php, used for download test. must be relative to this js file
    url_ul: "upload", // path to an empty file, used for upload test. must be relative to this js file
    url_ping: "upload", // path to an empty file, used for ping test. must be relative to this js file
    url_getIp: "upload", // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
